...
説明文aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa<br>
...
<div>¥{{product.price}}</div>
  ...
  <Selectbox />
  <div class="topitem">
  <!-- <router-link v-bind:to="{ name : 'shop_item_cart'}" class="btn"> -->
  <!-- </router-link> -->
  <!-- <button @click="submit" type="button" class="btn">ADD TO  SHOPPING CART</button> -->
</div>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        product:{ name: 'ikuyoT', price: '3000' },
